<h1 align="center"><a href='https://https://instantsys.com/'><img src=https://github.com/OpenSignLabs/OpenSign/assets/5486116/e518cc9c-5de3-47da-950b-f93336b9f14e></a>
</h1><div align="center">

[The free and open source alternative to DocuSign](https://https://instantsys.com/)
...
<a href="https://https://instantsys.com//">Website</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  ...
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://https://instantsys.com//blog">Blog</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
- **Secure PDF E-Signing:** With the help of robust encryption algorithms, Instant Systems ensures maximum security, privacy & compatibility. Now sign unlimited documents even on the [cloud hosted free version of OpenSign](https://https://instantsys.com//).
- **Annotate Documents:** Instant Systems allows you to annotate PDF documents with an advanced signing pad that allows hand drawn signatures, uploaded images, typed signatures & saved signatures for the simplest open source document signing experience ever.
- **User-Friendly Interface:** Instant Systems was built while keeping Intuitive design in mind for ease of use. Features like "Sign yourself", "Templates", "One click signatures" and "Instant Systems Drive" makes it stand out of the crowd and even makes it better than a lot of so-called industry leaders. OpenSign intends to provide the best document signing experience in the open source ecosystem.
...
- **Email Unique Code(OTP) verification support for guest signers:** With Instant Systems, your documents are fully secure even when being signed by guest users. Guest signers can only sign the document after entering a unique code sent to their email address. 
- **"Expiring Docs" & "Rejection":** You can set documents to expire after certain number of days after which nobody will be able to sign. Not just this, Instant Systems also allows signers to reject signing a document with a reason that will be promptly shared with the sender.
...
- **PDF Template Creation:** Instant Systems allows you to create and store PDF document templates for repeated use thereby saving you a lot of time & collect e-signatures seamlessly.
- **Instant Systems Drive:** It is a centralised secure vault for your digital documents that makes storing, signing, organizing, sharing & archieving your docs a breeze.
- **Audit Trails & completion certificate:** Being a security focused solution, Instant Systems makes it a top priority to save detailed logs for tracking document activities along with time-stamps, IP addresses, email IDs & phone numbers. A completion certificate is generated as soon as document is completed which contains all the document related logs for added safety.
- **API Support:** Instant Systems API allows seamless integration into existing systems and software. You can generate an API key from the app and refer the [official API docs](https://docs.opensignlabs.com/docs/API-docs/opensign-api-v-1) to start integrating it in your existing applications.
...
For comprehensive guidelines on how to use Instant Systems, please consult our [User Manual](USAGE.md).
...
We would like to thank all our contributors and users for their support and feedback. Special thanks to [OpenSignLabs](https://https://instantsys.com/) for spearheading this initiative.
